...
Find the number of users that made additional in-app purchases due to the success of the marketing
campaign.
...
SELECT a.user_id --, a.product_id, a.created_at, b.user_id, b.product_id, b.created_at
FROM except_first_app_purchases AS a
LEFT JOIN first_app_purchases AS b
ON a.user_id = b.user_id AND a.product_id = b.product_id
